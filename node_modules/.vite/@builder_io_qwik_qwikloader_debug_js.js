// node_modules/@builder.io/qwik/qwikloader.debug.js
!function() {
        ...
        for (const qrl of attrValue.split("\n")) {
          ...
          if (url) {
            ...
            const handler = (window[url.pathname] || await import(
              /* @vite-ignore */
              String(url).split("#")[0]
            ))[symbolName] || error(url + " does not export " + symbolName);
...
*/
//# sourceMappingURL=@builder_io_qwik_qwikloader_debug_js.js.map
